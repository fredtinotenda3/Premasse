...
export default async function ServicesPage() {
  ...
  return (
    <div className="max-w-4xl">
          ...
          <tbody className="divide-y divide-gray-50">
            {services.map((service) => (
              <tr key={service.id} className="hover:bg-gray-50/60 transition-colors duration-100">
                ...
                {/* Category */}
                <td className="px-5 py-4">
                  <span className="font-body text-[10px] tracking-[0.15em] uppercase font-semibold text-gold border border-gold/30 px-2 py-0.5 rounded-sm">
                ...
                <td className="px-5 py-4">
                  <span
                    className={`inline-block font-body font-semibold text-[10px] px-2.5 py-1 rounded-sm border uppercase tracking-widest ${
                      service.isActive
      ...
      {/* Info note */}
      <p className="font-body text-slate/40 text-xs mt-4">
